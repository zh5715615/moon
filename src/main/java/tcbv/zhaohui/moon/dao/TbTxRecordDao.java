...
public interface TbTxRecordDao {
    ...
    List<TbTxRecord> loserList(@Param("gameType") int gameType, @Param("turns") int turns, @Param("loser") int loser);
    ...
    Double betNumberEvent(@Param("gameType") int gameType, @Param("turns") int turns, @Param("betType") String betType);
}
